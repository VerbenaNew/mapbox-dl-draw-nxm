...
module.exports = function render() {
  ...
  store.sources.cold = store.isDirty ? [] : store.sources.cold.filter((geojson) => {
    //pcj 解决vertex加上ID之后节点渲染问题 20180117
    let id = geojson.properties.id;
    if (geojson.properties.meta === "midpoint" || geojson.properties.meta === "vertex" || geojson.properties.meta === "snaped") id = geojson.properties.parent;
  ...
  function renderFeature(id, source) {
    ...
    if (id == 'snapedid') {//我是捕捉点;snapedbox
      // console.log(feature)
    }
