...
module.exports = {
  ...
  isActiveVertex: function (e) {
    const featureTarget = e.featureTarget;
    if (!featureTarget) return false;
    if (!featureTarget.properties) return false;
    return e.featureTarget.properties.active === Constants.activeStates.ACTIVE && featureTarget.properties.meta === Constants.meta.VERTEX;
  },
  ...
  isCtrlKey: function (e) {
    if (!e.originalEvent) return false;
    return e.originalEvent.ctrlKey === true;
  },
  isZkey: function (e) {
    return e.keyCode === 90;
  },
