...
//获取变化要素id
ModeInterface.prototype.getChangedIds= function() {
  return this._ctx.store.getChangedIds ();
};
//
ModeInterface.prototype.undoPush= function(ff) {
  return this._ctx.store.undoPush (ff);
};
ModeInterface.prototype.undoPop= function() {
  return this._ctx.store.undoPop();
};
ModeInterface.prototype.redoPush= function(ff) {
  return this._ctx.store.undoPush (ff);
};
ModeInterface.prototype.redoPop= function() {
  return this._ctx.store.undoPop();
};
ModeInterface.prototype.setChangedIds= function(ids) {
  return this._ctx.store.changedIds=ids;
};